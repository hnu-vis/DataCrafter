...
import argparse
from experiments.trainer import M2MTrainer
import os
...
def cdr_pipeline(config_path):
    ...
    trainer = M2MTrainer(clr_model, cfg.exp_params.dataset, cfg, result_save_dir, config_path,
...
def parse_args():
    ...
    parser.add_argument("--configs", type=str, default="configs/M2M.yaml", help="configuration file path")
